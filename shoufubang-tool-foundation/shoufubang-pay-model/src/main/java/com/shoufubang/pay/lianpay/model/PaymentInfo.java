package com.shoufubang.pay.lianpay.model;

import java.io.Serializable;

import com.shoufubang.pay.lianpay.config.PartnerConfig;
import com.shoufubang.pay.lianpay.util.DateUtil;
...
public class PaymentInfo implements Serializable{
    ...
    // 商户提交参数
    private  String version = PartnerConfig.VERSION;              // 接口版本号
    private  String oid_partner = PartnerConfig.OID_PARTNER;    // 商户编号
    private  String sign_type = PartnerConfig.SIGN_TYPE ;            // 签名方式
    private  String busi_partner = PartnerConfig.BUSI_PARTNER;         // 商户业务类型
    private String sign;                 // 签名
    private  String no_order =DateUtil.getCurrentDateTimeStr1();             // 商户唯一订单号
    private  String dt_order =DateUtil.getCurrentDateTimeStr1();  // 商户订单时间
    private String            name_goods;           // 商品名称
    private String            info_order;           // 订单描述
    private String            money_order;          // 交易金额 单位为RMB-元
    private  String   notify_url = PartnerConfig.NOTIFY_URL;           // 服务器异步通知地址
    private  String   url_return = PartnerConfig.URL_RETURN;           // 支付结束回显url
    private String            app_request;          // 请求应用标识 1：Android 2：ios 3：WAP
    private  String    valid_order = PartnerConfig.VALID_ORDER ;  // 订单有效时间 分钟为单位，默认为10080分钟（7天）
    ...
    // 用户提交参数
//    private  String  pay_type = PartnerConfig.SIGN_TYPE;  // 支付方式 2：快捷支付（借记卡） 3：快捷支付（信用卡）
    ...
    private  String    rsa_public = PartnerConfig.YT_PUB_KEY;   // 商户RSA公钥
    private  String    rsa_private =PartnerConfig.TRADER_PRI_KEY;          // 银通验证商户私钥
    private  String    key_md5 =PartnerConfig.MD5_KEY;              // MD5KEY值
